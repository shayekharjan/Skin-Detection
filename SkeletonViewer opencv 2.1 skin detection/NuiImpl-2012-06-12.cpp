...
//cvCvtColor(colorim1,colorim2,CV_BGRA2BGR);
//for (int channel = 1; channel <= 3; channel++)
//{
//cvSetImageCOI(colorim1, 4);
//cvSetImageCOI(colorim2, 3);
//cvCopy(colorim1, colorim2);
//}
//cvResize( colorim1, colorim2, CV_INTER_LINEAR);
//cvSplit( colorim2, temp0, temp1, temp2 );

//cvMerge(colorim1, NULL, NULL, NULL, colorim2);
// reset the COI (Channel Of Interrest) to all channels
//cvSetImageCOI(colorim1, 0);
//cvSetImageCOI(colorim2, 0);
//cvResize( colorim1, colorim2, CV_INTER_LINEAR); 
//colorim2 = cvQueryFrame(camImage);
//cvCvtColor(colorim1,colorim2,CV_BGRA2BGR);
...
//cvNamedWindow("Test Color Image", CV_WINDOW_AUTOSIZE );
        //cvShowImage("Color Image",colorim1);
//cvShowImage("Test Color Image 2",camImage);
//cvShowImage("Test YCrCb Image",YCrCb);
//cvNamedWindow("RGB_IMAGE", CV_WINDOW_AUTOSIZE );
  //cvNamedWindow("YCrCb_IMAGE", CV_WINDOW_AUTOSIZE );
//cvNamedWindow("TEST_IMAGE 0", CV_WINDOW_AUTOSIZE );
//cvNamedWindow("TEST_IMAGE 1", CV_WINDOW_AUTOSIZE );
//cvNamedWindow("TEST_IMAGE 2", CV_WINDOW_AUTOSIZE );
//cvNamedWindow("TEST_IMAGE 3", CV_WINDOW_AUTOSIZE );
  
//cvShowImage("RGB_IMAGE",original_img);
//cvShowImage("YCrCb_IMAGE",YCrCb);
//cvShowImage("SKIN_IMAGE",Skin);
//cvShowImage("TEST_IMAGE 0",temp0);
//cvShowImage("TEST_IMAGE 1",temp1);
//cvShowImage("TEST_IMAGE 2",temp2);
//cvShowImage("TEST_IMAGE 3",temp3);
//cvShowImage("TEST_IMAGE 3",temp);
...
/*
YCBCR = rgb2ycbcr(origim);
YCBCR2 = rgb2ycbcr(origim2);
newimage=uint8(zeros(240,320,3));
 depthimage=nan*ones(240,320);
 skinimage=zeros(240,320);
 skinimage2=zeros(480,640);
 newimage2=zeros(240,320,3);
q1=0;
for y=1:240
    for x=60:320        
        zz=deptharray(y,x);
